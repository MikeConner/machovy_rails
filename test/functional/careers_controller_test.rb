...
class CareersControllerTest < ActionController::TestCase
  ...
  test "should create career" do
    assert_difference('Career.count') do
      post :create, career: { description: @career.description, email_contact: @career.email_contact, email_subject: @career.email_subject, expiration: @career.expiration, title: @career.title }
    end
  ...
  test "should update career" do
    put :update, id: @career, career: { description: @career.description, email_contact: @career.email_contact, email_subject: @career.email_subject, expiration: @career.expiration, title: @career.title }
    assert_redirected_to career_path(assigns(:career))
  end
