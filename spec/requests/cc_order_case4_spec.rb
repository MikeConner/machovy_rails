describe "Credit card Case 4 - customer using new card and saving it" do
  ...
  describe "Sign in" do
    ...
    pending "Customer -- using new card and saving it (case 4)", :js => true do
...
=end                        
      ...
      describe "Card should be saved" do
        ...
        describe "should show new default card" do
          before { visit order_promotion_path(promotion) }
          
          it { should have_content("Use card with last 4 digits '#{AMEX[-4..-1]}'") }
        end              
      end
    end
  end
