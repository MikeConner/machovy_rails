...
describe "SecureNet Certification script (visa)" do
  ...
  describe "Visa sales" do
    before do
      @credit_cards = [{:number => '4444 3333 2222 1111', :verification_value => '999', :amount => 1100, :avs => '20850'},
                       {:number => '4005 5192 0000 0004', :verification_value => '999', :amount => 1100, :avs => '20704'},
                       {:number => '4275 3300 1234 5675', :verification_value => '996', :amount => 1200, :avs => '20850'},
                       {:number => '4012 0000 3333 0026', :verification_value => '996', :amount => 2100, :avs => '20704'}]
      @bad_card = {:number => '4012 8888 8888 1881', :verification_value => '999', :amount => 1100, :avs => '20704'}
    end

    describe "should pass test 1" do
      before {
      ...
      describe "authorize and capture (test 9)" do
        before do
    ...
    describe "should pass test 2" do
      before {
      ...
      describe "authorize and capture (test 10)" do
        before do
    ...
    describe "should pass test 3" do
      before {
      ...
      describe "authorize and capture (test 11)" do
        before do
    ...
    describe "should pass test 4" do
      before {
      ...
      describe "authorize and capture (test 12)" do
        before do
          @response = gateway.purchase(@credit_cards[3][:amount], @card, 
                                       :order_id => Utilities::generate_order,
                                       :shipping_required => true, # set Physical goods flag 
                                       :billing_address => @address,
                                       :certification_test => true) # set test to false so that it will clear
          @transaction_id = @response.authorization
          if !@response.success?
            puts @response.message
            puts @response.inspect
    ...
    describe "bad cards" do
      ...
      describe "test 16" do
        ...
        it "should return the correct response" do
          ...
          @response.cvv_result['message'].should be == 'No Match'
          @response.authorization.should_not be_blank
          @response.params['response_reason_text'].should be == 'Declined  Lost Card (Pick up)'
        end
      end
